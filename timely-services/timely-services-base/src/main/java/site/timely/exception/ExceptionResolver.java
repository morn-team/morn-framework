...
public class ExceptionResolver {
  ...
  @ExceptionHandler
  @ResponseBody
  public HttpResult doResolveException(HttpServletRequest request, HttpServletResponse response,
      Exception e) {
...
//    }
   ...
   * @return json
   */
  private HttpResult resolveException(HttpServletRequest request, HttpServletResponse response,
      Exception e) {
    ...
    if (e instanceof ApplicationException) {
      ...
      if (cause != null) {
        ...
        logger.error(
            "异常[code]:" + exception.getCode() + ",[description]:" + exception.getDescription());
      }
    } else {
