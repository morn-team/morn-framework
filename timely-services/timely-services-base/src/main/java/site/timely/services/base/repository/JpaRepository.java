...
public interface JpaRepository<T, ID extends Serializable>
     ...
     */
    default T findOne(T model, ConditionSpecification<T> specification) {
        return this.findOne(
                JpaConditionUtils.specification(model, specification));
    }
     ...
     * @see JpaSpecificationExecutor
     */
    default List<T> findAll(T model, ConditionSpecification<T> specification) {
        return this.findAll(
                JpaConditionUtils.specification(model, specification));
    }
    ...
    default List<T> findAll(T model, ConditionSpecification<T> specification,
                            Sort sort) {
        return this.findAll(
                JpaConditionUtils.specification(model, specification), sort);
    }
     ...
     * @see JpaSpecificationExecutor
     */
    default Page<T> findAll(T model, ConditionSpecification<T> specification,
                            Pageable pageable) {
        return this.findAll(
                JpaConditionUtils.specification(model, specification), pageable);
    }
