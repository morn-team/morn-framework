...
public class HttpExceptionBody extends ExceptionBody implements HttpExceptionAdapter {
    ...
    public HttpExceptionBody(String code, ExceptionLevel level, String title, String description, String solution) {
        super(code, level, description, solution);
        this.title = title;
    }

    public HttpExceptionBody(Exception exception, String code, ExceptionLevel level, String title, String description, String solution) {
